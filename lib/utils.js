...
function convertMSToHoursAndMinutes(date, logDateAndHours) {
    var newDate;
    var newDate2;
    if (logDateAndHours) newDate = [date.getDate(), date.getMonth(), date.getHours(), date.getMinutes(), date.getSeconds()];
    ...
    if (logDateAndHours) {
        ...
        newDate2 = `${newDate[0]}/${newDate[1]} ${newDate[0]}:${newDate[1]}:${newDate[2]}`;
    } else {
